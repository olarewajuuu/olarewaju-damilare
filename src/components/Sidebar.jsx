...
const Sidebar = () => {
  ...
  return (
    <div
      className={`lg:fixed lg:w-96 lg:h-screen shadow-lg transition-colors duration-300 ${
    ...
    >
      ...
      <div className="p-6 flex flex-col items-center">
        ...
        <button
          className={`mt-4 lg:hidden flex items-center justify-center p-2 rounded-lg transition-colors ${
          ...
          <a href="https://github.com/" target="_blank" rel="noopener noreferrer">
            <FaGithub
              className={`text-2xl transition-colors ${
                isDarkMode ? "text-white hover:text-emerald-400" : "text-gray-900 hover:text-emerald-500"
              }`}
            />
          </a>
